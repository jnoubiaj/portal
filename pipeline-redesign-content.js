  ...
  var PIPELINE_STAGES = [
    ...
    { name: 'Credit Optimization', sub: 'Remove & Repair',
      ...
      client:   ['Remove Inquiries','Turn Off Fraud Alerts','Add Authorized User','Pay Down Utilization'],
      internal: ['Remove Inquiries','Turn Off Fraud Alerts','Add Authorized User','Pay Down Utilization'],
      idays:    [3, 2, 30, 60] },
    { name: 'Funding Strategy',    sub: 'Plan & Sequence',
      ...
      internal: ['Build Funding Sequence & Select Banks','Set Application Order','Determine Application Numbers'],
      idays:    [1, 1, 1] },
    { name: 'Bank Relationships',  sub: 'Open Accounts',
      color: '#10b981', light: '#ecfdf5', border: '#a7f3d0', dark: '#047857',
      client:   ['Assign Target Banks','Track Personal Account Open Date','Verify Business Account & Open Date','Open Business Account & Deposit Funds'],
      internal: ['Assign Target Banks','Track Personal Account Open Date','Verify Business Account & Open Date','Open Business Account & Deposit Funds'],
      idays:    [1, 1, 1, 7] },
    { name: 'Application Phase',   sub: 'Submit & Track',
      color: '#f97316', light: '#fff7ed', border: '#fed7aa', dark: '#c2410c',
      client:   ['Attend Bank Appointment','Confirm Submission','Upload Requested Documents','Handle Reconsideration Calls'],
  ...
  function renderTaskModal(clientId, viewStage) {
    ...
    // Task row builder
    function taskRow(key, label, checked, onchange, onremove, badge) {
